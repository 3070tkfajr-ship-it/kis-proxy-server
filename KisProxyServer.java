...
private static final String AZIZ_PROMPT =
    ...
    "모호한 일반론은 금지야. 반드시 이 이미지에서 실제로 관찰되는 구체적 근거(예: 몇 번째 캔들에서 몇 선과 몇 선이 semi 교차했는지, 현재가와 VWAP의 대략적 이격 정도, %K/%D의 대략적 위치)를 최소 1개 이상 문장마다 인용해서 말해. 화면에서 확인 안 되는 내용은 추측하지 말고 '이미지에서 명확히 확인 안 됨'이라고 말해.\n\n" +
    "[분석 시점 구분]\n" +
