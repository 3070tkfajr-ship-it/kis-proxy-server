    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        try {
            ...
            if ("D".equalsIgnoreCase(tf)) {
                ...
                // 🚨 핵심 수정: 항상 15:30(장마감)부터 조회하면, 아직 안 지난 미래 시각을 요청하게 되어
                // 한투 API가 마지막 체결가를 그대로 복사한 '가짜 채움 데이터'(거래량 0)를 줘서 일직선처럼 보이는 버그가 있었음.
                // → 실제 현재 시각(한국 기준)과 장마감(15:30) 중 더 이른 시각부터 조회하도록 수정.
