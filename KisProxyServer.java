...
public class KisProxyServer {
    ...
    "<b>1. VWAP 분석 (OO/35점):</b> 상세 분석 (구체적 근거 인용 필수)\n" +
    "<b>2. EMA 분석 (OO/40점):</b> 상세 분석 (구체적 근거 인용 필수)\n" +
    "<b>3. Stoch RSI 분석 (OO/21점):</b> 상세 분석 (구체적 근거 인용 필수)\n" +
    "<br><b>💡 롱 가능 점수: OO / 96점</b>\n" +
    "<b>💡 숏 가능 점수: OO / 96점</b>\n" +
    "<b>📍 손절가/목표가/손익비:</b> 한 줄 서술\n" +
    "<b>🔥 아지즈의 한 줄 평:</b> 롱/숏/관망 중 하나를 명확히 제시하고, 그 이유와 구체적 행동 지침(진입 기준가, 손절 기준)을 서술\n" +
